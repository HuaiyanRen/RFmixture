...
model_list = ['GTR+FU+R8', 'l1t90_1','l1t90_2','l2t90_1','l2t90_2','l5t90_1','l5t90_2','l10t90_1','l10t90_2']
    
with open('mf_results.csv','w+',newline='') as csvf:
    csv_write = csv.writer(csvf)
    csv_write.writerow(['partition', 'q1', 'l1t90_1','l1t90_2','l2t90_1','l2t90_2','l5t90_1','l5t90_2','l10t90_1','l10t90_2'])   
    
    
for part_name in part_list:
    file_name = 'mf_dec2/' + part_name + '.iqtree'
    order_dict = {}
    current_order = 1
