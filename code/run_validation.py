...
def running_modelfinder(paras):
    ...
    if method == 'MF' or method == 'MFP':
        ...
        cmd = '/data/huaiyan/software/iqtree-2.2.6.mix-Linux/bin/iqtree2 -s ' + file_name + ' -m "ESTMIXNUM" -mset GTR -mrate E,I,G,I+G,R,I+R -opt_qmix_criteria 1 -opt-rhas-once -pre mix_lrt/' + file_name + ' -nt 1'
    elif method == 'mix_bic':
        cmd = '/data/huaiyan/software/iqtree-2.2.6.mix-Linux/bin/iqtree2 -s /data/huaiyan/predefine/mammal_wu/validation/' + file_name + ' -m MIX+MFP -mset GTR -mrate E,I,G,I+G,R,I+R -lrt 0 -merit BIC -mrate-twice 0 -bb 1000 -pre mix_bic/' + file_name + ' -nt 1'
    elif method == 'q10':
