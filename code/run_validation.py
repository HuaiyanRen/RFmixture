...
def running_modelfinder(paras):
    ...
    if method == 'MF' or method == 'MFP':
        ...
        cmd = 'iqtree2 -s ' + file_name + ' -m GTR+R8{0.2476,0.03401,0.166,0.1642,0.112,0.4501,0.1241,0.8255,0.1341,1.281,0.1461,2.143,0.05735,3.995,0.01282,7.601} -pre one/' + file_name + ' -nt 1 -redo'
    elif method == 'mix':
        cmd = 'iqtree2 -s ' + file_name + ' -m "ESTMIXNUM" -mset GTR -mrate R8{0.2476,0.03401,0.166,0.1642,0.112,0.4501,0.1241,0.8255,0.1341,1.281,0.1461,2.143,0.05735,3.995,0.01282,7.601} -opt_qmix_criteria 1 -opt-rhas-once -pre mix/' + file_name + ' -nt 1 -redo'
    elif method == 'q10':
