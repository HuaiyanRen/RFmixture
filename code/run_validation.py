...
def running_modelfinder(paras):
    ...
    if method == 'MF' or method == 'MFP':
        ...
        cmd = 'iqtree2 -s ' + file_name + ' -m "ESTMIXNUM" -mrate E,I,G,I+G,R,I+R -opt_qmix_criteria 1 -opt-rhas-once -pre mix_lrt/' + file_name + ' -nt 1 -redo'
    elif method == 'mix_bic':
        cmd = 'iqtree2 -s ' + file_name + ' -m "ESTMIXNUM" -mrate E,I,G,I+G,R,I+R -opt_qmix_criteria 2 -opt-rhas-once -pre mix_bic/' + file_name + ' -nt 1 -redo'
    elif method == 'q10':
