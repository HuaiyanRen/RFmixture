...
def running_modelfinder(paras):
    ...
    if method == 'MF' or method == 'MFP':
        ...
        cmd = 'iqtree2 -s ' + file_name + ' -m GTR+R8 -pre one/' + file_name + ' -nt 1 -redo'
    elif method == 'mix':
        cmd = 'iqtree2 -s ' + file_name + ' -m "ESTMIXNUM" -mset GTR -mrate R8 -opt_qmix_criteria 1 -opt-rhas-once -pre mix/' + file_name + ' -nt 1 -redo'
    elif method == 'q10':
